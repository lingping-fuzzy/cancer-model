...
model_path = ['trained_models/efficient_combine_model_cut_1.pt', 'trained_models/resnet_combine_model_cut_1.pt',
              'trained_models/res_combine_model_tune.pt', 'trained_models/eff_combine_model_tune.pt', 'trained_models/retrain_eff_combine_model_tune1.pt']
cut_or = True
...
# save_output(trainloader, model_path[3], loder_name= 'train', cut=cut_or, model_name='effnet')
# save_output(trainloader, model_path[2], loder_name= 'train', cut=cut_or, model_name='resnet')

# save_output(val_loader, model_path[3], loder_name= 'val', cut=cut_or, model_name='effnet')
# save_output(val_loader, model_path[2], loder_name= 'val', cut=cut_or, model_name='resnet')
#
# save_output(test_loader, model_path[3], loder_name= 'test', cut=cut_or, model_name='effnet')
# save_output(test_loader, model_path[2], loder_name= 'test', cut=cut_or, model_name='resnet')


save_output(trainloader, model_path[4], loder_name= 'train', cut=cut_or, model_name='effnet', add='retrain_')
save_output(val_loader, model_path[4], loder_name= 'val', cut=cut_or, model_name='effnet', add='retrain_')
save_output(test_loader, model_path[4], loder_name= 'test', cut=cut_or, model_name='effnet', add='retrain_')

save_prob(val_loader, model_path[4], loder_name= 'val', cut=cut_or, model_name='effnet', add='retrain_')
save_prob(test_loader, model_path[4], loder_name= 'test', cut=cut_or, model_name='effnet', add='retrain_')
